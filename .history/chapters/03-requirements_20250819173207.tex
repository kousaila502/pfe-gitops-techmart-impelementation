...
\hline
User Service & 7.8 & GKE & Kubernetes orchestration, & GitOps automation for \\
 & & & High availability, & complex authentication \\
 & & & Advanced monitoring & workflows \\
\hline
Order Service & 8.2 & GKE & Multi-database support, & GitOps self-healing for \\
 & & & Transaction processing, & complex business logic \\
 & & & Resource scaling & and integrations \\
\hline
Product Service & 5.4 & Heroku & Platform optimization, & Traditional CI/CD \\
 & & & Managed MongoDB, & simplicity for CRUD \\
 & & & Simplified deployment & operations \\
\hline
Cart Service & 7.5 & Heroku & JVM optimization, & Traditional CI/CD with \\
 & & & Managed Redis, & platform-managed \\
...
% TODO: Add Figure 3.2 - Hybrid architecture diagram showing GitOps services (GKE) communicating with Traditional CI/CD services (Heroku) through secure API patterns and shared authentication
