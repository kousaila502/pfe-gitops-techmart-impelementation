...
The authentication architecture implements centralized JWT-based security \cite{rfc7519jwt} where the User Service serves as the primary authentication provider for all platform services.
